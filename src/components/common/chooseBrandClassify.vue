    ...
    <div class="choose-box">
        ...
        <div style="margin-top: 10px">
            <div class="check-area">
                ...
                <div>
                    <ul v-loading="firstLoading" v-if="brandList">
                    ...
                    .then(res => {
                        ...
                        if (res.data.code == 200) {
                            ...
                            for (let i in that.brandList) {
                                ...
                                that.brandList[0].checked = true;
                                that.brandList[i].allChecked = false;
                                that.brandList[i].classifyList=[]
                            }
                        ...
                        if (res.data.code == 200) {
                            for (let i in res.data.data) {
                                ...
                                if(that.classifyId.indexOf(itemId)==-1&&that.brandList[index].classifyList.indexOf(itemId)==-1){
                                    ...
                                    that.brandList[index].classifyList[i].checked = false;
                                    that.brandList[index].classifyList[i].hasChecked = false;
                                }
                            }
                        } else {
                            that.$message.warning(res.data.msg);
